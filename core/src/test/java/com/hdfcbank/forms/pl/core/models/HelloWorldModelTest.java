 ...
 */
package com.hdfcbank.forms.pl.core.models;
...
import com.hdfcbank.forms.pl.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "HDFC_PL_FORMS/components/helloworld");
