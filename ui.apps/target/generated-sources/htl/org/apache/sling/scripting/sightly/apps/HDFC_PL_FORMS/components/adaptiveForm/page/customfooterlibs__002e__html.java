        ...
        if (renderContext.getObjectModel().toBoolean(var_testvariable0)) {
            {
                ...
                {
                    boolean var_templateoptions2_field$_async = true;
                    {
                        Object var_templateoptions2_field$_categories = _global_clientlibref;
                        {
                            java.util.Map var_templateoptions2 = obj().with("async", var_templateoptions2_field$_async).with("categories", var_templateoptions2_field$_categories);
...
out.write("\n    ");
{
    ...
    {
        boolean var_templateoptions4_field$_async = true;
        {
            String var_templateoptions4_field$_categories = "HDFC_PL_FORMS.base";
            {
                java.util.Map var_templateoptions4 = obj().with("async", var_templateoptions4_field$_async).with("categories", var_templateoptions4_field$_categories);
...
out.write("\n        ");
{
    ...
    if (var_testvariable5) {
        {
            Object var_templatevar6 = renderContext.getObjectModel().resolveProperty(_global_clientlib, "js");
            {
                boolean var_templateoptions7_field$_async = true;
                {
                    String var_templateoptions7_field$_categories = "core.forms.components.runtime.all";
                    {
                        java.util.Map var_templateoptions7 = obj().with("async", var_templateoptions7_field$_async).with("categories", var_templateoptions7_field$_categories);
