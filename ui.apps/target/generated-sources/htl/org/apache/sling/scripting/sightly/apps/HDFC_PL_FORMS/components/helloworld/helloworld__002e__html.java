 ...
 * under the License.
 ******************************************************************************/
package org.apache.sling.scripting.sightly.apps.HDFC_PL_FORMS.components.helloworld;
...
out.write("\n    ");
_global_model = renderContext.call("use", com.hdfcbank.forms.pl.core.models.HelloWorldModel.class.getName(), obj());
{
